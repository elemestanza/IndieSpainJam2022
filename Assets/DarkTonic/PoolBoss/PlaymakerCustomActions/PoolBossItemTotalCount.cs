...
[Tooltip("Get total number of a pooled item set up in Pool Boss, spawned and despawned copies")]
public class PoolBossItemTotalCount : FsmStateAction {
	...
	public override void OnEnter() {
        ...
        intVariable.Value = itemInfo.DespawnedClones.Count + itemInfo.SpawnedClones.Count;
